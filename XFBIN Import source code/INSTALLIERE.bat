@echo off
REM ============================================================
REM  XFBIN Import 2.1.6 - Paket erstellen + installieren
REM
...
for %%V in (2016 2017 2018 2019 2020 2021 2022 2023 2024 2025 2026 2027) do (
    if exist "%SRC%\%%V\XfbinImport.dlu" (
        ...
        REM Ergebnis der Kopie pruefen.
        REM
        REM  Die Sperrpruefung oben testet die INSTALLIERTE Datei,
        REM  bevor irgendetwas passiert. Hier geht es um die Kopie
        REM  selbst - sie kann auch aus anderen Gruenden scheitern,
        REM  etwa weil zwischendurch jemand Max gestartet hat.
        REM
        REM  Ohne diese Pruefung stand hier ein unbedingtes "OK",
        REM  und man ging mit neuem Skript und altem Plugin nach
        REM  Hause. Eigene Zaehlvariable: LOCKED gehoert der
        REM  Pruefung oben und ist dort eine Zeichenkette.
        if errorlevel 1 (
            echo  %%V: FEHLER - Datei liess sich nicht ersetzen
            set /a COPYFAIL+=1
        ) else (
            echo  %%V: OK
            set /a FOUND+=1
...
if !COPYFAIL! GTR 0 (
    echo ========================================
    echo  UNVOLLSTAENDIG installiert.
    echo ========================================
    echo.
    echo  !COPYFAIL! Plugin-Datei(en) liessen sich nicht ersetzen.
    echo  Die Skripte wurden aber aktualisiert - damit passen
    echo  Skript und Plugin nicht mehr zusammen.
    echo.
    echo  Meist heisst das: 3ds Max wurde zwischendurch gestartet.
    echo  Max schliessen und INSTALLIERE.bat erneut ausfuehren.
    echo.
    pause
    exit /b 1
)
